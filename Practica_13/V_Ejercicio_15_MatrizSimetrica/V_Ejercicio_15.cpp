/****************************************************************************** 
	...
	------------------------------
	Sobre la clase MiMatrizRectangularCaracteres del ejercicio anterior, añadir 
	un método para comprobar si es simétrica. Hacedlo primero calculando la 
	traspuesta de la matriz y viendo si es igual a su simétrica, usando los 
	métodos de los ejercicios anteriores. Hacedlo también comprobando 
	directamente si cada componente es igual a su simétrica y parando el 
...
public:
	...
	bool EsSimetrica() {
		...
		MiMatrizRectangularCaracteres traspuesta = ObtenerTraspuesta();
...
int main() {    
	...
	cout << "\n¿Es simetrica (0=No|1=Si)?: " <<  matriz.EsSimetrica() << " \n";
