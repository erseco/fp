/****************************************************************************** 
	...
	------------------------------
	Añadir un método EliminaRepetidos() que quite los elementos repetidos, de 
	forma que cada componente sólo aparezca una única vez. Se mantendrá la 
	primera aparición, de izquierda a derecha. Por ejemplo, 
	si el vector contiene {’b’,’a’,’a’,’h’,’a’,’a’,’a’,’a’,’c’,’a’,’a’,’a’,’g’}
	
	después de quitar los repetidos, se quedaría como sigue:
	{’b’,’a’,’h’,’c’,’g’}
...
int main(){    
	...
	vc1.PintarVector("Eliminar repetidos");

	//Eliminamos los repetidos
	vc1.EliminaRepetidosC();
